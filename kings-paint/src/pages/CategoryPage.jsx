...
const allProducts = [
  ...
  },
  {
    ...
    brand: "WoodCraft",
    price: 550.99,
    image: "/images/exterior-wood.png",
    rating: 4.5,
    reviews: 67,
    category: "Exterior",
    inStock: true,
...
const CategoryPage = () => {
  ...
  const categoryInfo = {
    interior: {
      ...
      image: '/images/categories/interior-category.jpg',
      icon: Home,
